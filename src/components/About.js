      ...
      <section id="about" className="text-gray-600 body-font">
        <div className="container mx-auto flex px-5 md:flex-row flex-col items-center">
          <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-left">
            <h1 className="about-title sm:text-4xl text-3xl mb-2 font-medium text-gray-900">
              {props.about_title_1}
            </h1>
            <p className="about-title2 text-success">{props.about_title_2}</p>
            <p className="description-text mb-10 leading-relaxed">
          ...
          <div className="lg:max-w-lg lg:w-full md:w-1/2 w-5/6 md:mt-16">
            <img
              className="object-cover object-center rounded"
              alt="AboutSectionPhoto"
              src={about_section_photo}
            />
          </div>
        </div>
      </section>
