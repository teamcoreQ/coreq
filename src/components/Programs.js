...
export default function Programs(props) {
  return (
    <>
      <section id="programs" className="text-gray-600 body-font pt-6">
        <div className="container px-5 py-10 mx-auto">
          <div className="flex flex-col text-center w-full mb-6 mt-10">
            ...
            <p className="lg:w-2/3 mx-auto leading-relaxed text-base">
              A little effort to those enthusiastic minds who are the future
              pioneers.
            </p>
          </div>
              ...
              <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                ...
                <div className="p-6">
                  ...
                  <h1 className="title-font text-lg font-medium text-gray-900 mb-1">
                    WordPress and Web Interface Design
                  </h1>
                  <p className="leading-relaxed mb-3">
                    Web development is a major part of today's world. Here's our
                    little effort on educating a system to develop a website
                    using WordPress.
                  </p>
